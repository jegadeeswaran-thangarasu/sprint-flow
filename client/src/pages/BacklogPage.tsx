  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm text-gray-400 mt-0.5">Backlog</p>
          </div>
        </div>
      ...
      <div className="flex flex-col items-center justify-center py-24 text-center border-2 border-dashed border-gray-200 rounded-xl bg-gray-50">
        ...
        <h2 className="text-base font-semibold text-gray-700 mb-2">Backlog coming soon</h2>
        <p className="text-sm text-gray-400 max-w-xs leading-relaxed">
          Sprint planning and backlog management will be built in the next phase. Stay tuned!
        </p>
      </div>
    </>
  );
